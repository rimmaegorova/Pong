...
public class HlavniOkno extends JFrame {
    ...
    private void initComponents() {
        ...
        labVyhra.setForeground(new Color(204, 0, 51));
        labVyhra.setFont(labVyhra.getFont().deriveFont(labVyhra.getFont().getStyle() | Font.BOLD, labVyhra.getFont().getSize() + 2f));
        contentPane.add(labVyhra);
        labVyhra.setBounds(115, 105, 315, labVyhra.getPreferredSize().height);
